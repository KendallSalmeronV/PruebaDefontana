...
namespace PruebaDefontana.Infraestructure.Persistance
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=lab-defontana-202310.caporvnn6sbh.us-east-1.rds.amazonaws.com;Initial Catalog=Prueba;User Id=ReadOnly;Password=d*3PSf2MmRX9vJtA5sgwSphCVQ26*T53uU");
            }
        }
